...
#define MEMORY_TAG_GEN(GEN_TYPE) \
    ...
    GEN_TYPE(MEMORY_TAG_HASHMAP) \
    GEN_TYPE(MEMORY_TAG_APPLICATION) \
    GEN_TYPE(MEMORY_TAG_TEXTURE) \
    GEN_TYPE(MEMORY_TAG_RENDERER) \
    GEN_TYPE(MEMORY_TAG_ENGINE) \
    GEN_TYPE(MEMORY_TAG_ENTITY) \
    GEN_TYPE(MEMORY_TAG_PHYSICS) \
    GEN_TYPE(MEMORY_TAG_MEMORY) \
    GEN_TYPE(MEMORY_TAG_PLATFORM) \
    GEN_TYPE(MEMORY_TAG_ASSET_MANAGER) \
    GEN_TYPE(MEMORY_TAG_GLTF_MODEL_LOADER) \
    GEN_TYPE(MEMORY_TAG_ASSET_GENERATOR) \
    GEN_TYPE(MEMORY_TOTAL_ALLOCATED) \
